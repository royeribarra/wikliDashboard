      ...
      <Content fluid>
        <Spin className="spin__center" tip="Ahi vamos..." spinning={props.spinnerDisplay}>
          <Row
            ...
            <Col md={6} lg={4}>
              <CardHeader style={{textAlign: "center", border: "1px solid rgba(0, 0, 0, 0.125)"}}>Bienvenido Tienda</CardHeader>
              <Card body>
                <Form
...
export default connect(mapStateToProps, mapDispatchProps)(LoginTienda);